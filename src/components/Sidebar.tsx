  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-[260px] bg-white border-r border-slate-100 flex flex-col z-50 font-sans">
      ...
      <div className="flex-1 overflow-y-auto px-4 space-y-2 py-4">
        ...
        {/* Exact User Order: INICIO, FINANZAS, INGRESOS, EGRESOS, PRODUCCION, METAS, PACIENTES, CONFIGURACION, ARANCELES */}
      ...
      <div className="p-4 border-t border-slate-100">
        <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50 border border-slate-100 hover:bg-slate-100 transition-colors cursor-pointer group">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-bold text-slate-900 truncate group-hover:text-teal-600 transition-colors">Dra. Lopez</p>
