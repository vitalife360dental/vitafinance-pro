...
export function KpiCard({ title, value, icon: Icon, trend, color = 'blue', variant = 'default' }: KpiCardProps) {
    ...
    if (isPrimary) {
        return (
            <div className="bg-gradient-to-br from-[#5dc0bb] to-teal-600 p-5 rounded-2xl shadow-xl shadow-[#5dc0bb]/30 text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-teal-50 text-sm font-medium">{title}</p>
                </div>
                {/* Decorative Pattern */}
    ...
    const colorStyles = {
        blue: { bg: 'bg-[#5dc0bb]/10', text: 'text-[#5dc0bb]', border: 'border-[#5dc0bb]/20' },
